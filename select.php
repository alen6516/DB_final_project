        ...
        <div id="grap">
            ...
            <div id="right">
                ...
                <?php
                    ...
                    # 輸出資料
                    echo '<form action="select_receive.php" method="post">';
                        ...
                        for ($y=-1 ; $y<$row_total_2 ; $y++){
                            for ($x=0 ; $x<$field_2 ; $x++){
                                ...
                                if ($y == -1){
                                    ...
                                    if ($k == 0){
                                        echo '<input type="checkbox" size=40 class="select_input" name="select_input[]" value="'.$x.'"><br>';
                                    }
                                    else {
                                        echo '<input type="checkbox" size=40 class="select_input" name="select_input[]" disabled="disabled" value="'.$x.'"><br>';
                                    }
                    ...
                    echo '<span>select where</span><input type="text" size=50 class="select_condition" name="select_condition"><br>';
                    echo '<input type="submit" name="select_send" value="send">';
                    echo '</form>';
                ?>
