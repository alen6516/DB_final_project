        ...
        <div id="grap">
            ...
            <div id="right">
                ...
                <?php
                    ...
                    # 輸出資料
                    echo '<form action="update_receive.php" method="post">';
                        ...
                        for ($y=-1 ; $y<$row_total_2 ; $y++){
                            for ($x=0 ; $x<$field_2 ; $x++){
                                ...
                                if ($y == -1){
                                    ...
                                    if ($k == 0){
                                        echo '<input type="text" size=40 class="update_input" name="update_input[]"><br>';
                                    }
                                    else {
                                        echo '<input type="text" size=40 class="update_input" name="update_input[]" disabled="disabled"><br>';
                                    }
                    ...
                    echo '<span>update where</span><input type="text" size=50 class="update_condition" name="update_condition"><br>';
                    echo '<input type="submit" name="update_send" value="send">';
                    echo '</form>';
                ?>
