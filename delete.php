        ...
        <div id="grap">
            ...
            <div id="right">
                ...
                <?php
                    ...
                    # 輸出資料
                    echo '<form action="delete_receive.php" method="post">';
                    ...
                    for($k=0 ; $k<$row_total ; $k++){
                        ...
                        for ($y=-1 ; $y<$row_total_2 ; $y++){
                            for ($x=0 ; $x<$field_2 ; $x++){
                                                            //假如y等於-1就先輸出資料表欄位名稱
                                if ($y == -1){
                                    echo '<option>'.$fields_name_2[$x].'</option>';
                                }
                                else{
...
/**/
                    echo '<span>delete where </span><input type="text" size=50 class="delete_condition" name="delete_condition"><br>';
                    echo '<input type="submit" name="delete_send" value="send">';
                    echo '</form>';
                ?>
